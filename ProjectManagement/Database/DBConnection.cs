...
namespace ProjectManagement.Database
{
    internal class DBConnection
    {
        ...
        protected void ExecuteQueryThesis(Project thesis, string command, string typeExecution, bool flag)
        {
            string sqlStr = string.Format(command, DBTableNames.DBThesis,
        ...
        protected void ExecuteQueryPeople(User people, string command, string typeExecution, bool flag)
        {
            string sqlStr = string.Format(command, DBTableNames.DBPeople,
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBTask,
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBComment, 
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBEvaluation,
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBNotification,
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBMeeting,
        ...
        {
            string sqlStr = string.Format(command, DBTableNames.DBGiveUp,
