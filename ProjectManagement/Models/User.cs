...
namespace ProjectManagement.Models
{
    ...
    public class User
    {
        ...
        public User(string fullName, string citizenCode, DateTime birthday, EGender gender, string email, string phoneNumber,
        ...
        public User(string idAccount, string fullName, string citizenCode, DateTime birthday, EGender gender, string email, string phoneNumber,
        ...
        public User Clone()
        {
            return new User(idAccount, fullName, citizenCode, birthday, gender, email, phoneNumber, handle, role, workCode, password, avatarName);
        }
